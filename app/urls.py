...
urlpatterns = [
    ...
    path('parent/children/', parent_children, name='parent_children'),
    path('parent/children/<int:student_id>/', parent_child_overview, name='parent_child_overview'),
    path('parent/children/<int:student_id>/timetable/', parent_timetable, name='parent_timetable'),
    path('parent/children/<int:student_id>/documents/', parent_documents, name='parent_documents'),
    path('parent/children/<int:student_id>/documents/<int:document_id>/download/', parent_document_download, name='parent_document_download'),
    path('parent/children/<int:student_id>/payments/<int:payment_id>/receipt/', parent_payment_receipt, name='parent_payment_receipt'),
    ...
    path('parent/children/<int:student_id>/attendance/', parent_attendance, name='parent_attendance'),
    path('parent/children/<int:student_id>/library/', parent_library, name='parent_library'),
    path('parent/children/<int:student_id>/report.pdf', parent_report_download, name='parent_report_download'),
    path('parent/announcements/', parent_announcements, name='parent_announcements'),
    path('parent/calendar/', parent_calendar, name='parent_calendar'),
    path('parent/notifications/', parent_notifications, name='parent_notifications'),
    path('parent/notifications/<int:notification_id>/open/', parent_notification_open, name='parent_notification_open'),
    path('parent/messages/', parent_messages, name='parent_messages'),
    path('parent/messages/new/<int:student_id>/', parent_message_new, name='parent_message_new'),
    path('parent/messages/<int:conversation_id>/', parent_message_thread, name='parent_message_thread'),
    ...
    path('library/members/', library_members, name='library_members'),
